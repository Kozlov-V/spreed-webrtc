...
define([
	...
	'directives/page',
    'directives/pdfviewer'], function(_, onEnter, onEscape, statusMessage, buddyList, settings, chat, audioVideo, usability, audioLevel, fileInfo, screenshare, roomBar, socialShare, page, pdfviewer) {
